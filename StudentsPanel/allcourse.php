    ...
    <div class="container py-3">
        <header>
            <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
                <a href="index.php" class="d-flex align-items-center link-body-emphasis text-decoration-none">
                    <img class="d-block mx-auto me-3" src="https://cdn-icons-png.flaticon.com/128/669/669698.png" alt=""
                        width="65" height="55">
                    <span class="fs-4 fw-bold me-3">Fatima School</span>
                </a>

                < <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                    <a class="me-3 py-2 link-body-emphasis text-decoration-none dropdown-toggle" href="#" type="button"
                        data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-regular fa-user">
                        </i>
                        <?= $_SESSION['firstname'] ?>
                        <?= $_SESSION['lastname'] ?> <img src="../<?= $_SESSION['profil'] ?>" alt="" class="profil">
                    </a>
        ...
        <main>
            ...
            <div class="mb-3" style="max-width: 630px;">
                ...
                <div class="row g-0">
                    <div class="col-md-1">
                        <img src="../images/<?= $lesson['image'] ?>" alt="<?= $lesson['extension'] ?>"
                            class="img-fluid rounded-start" height="30" width="30" alt="...">
                    </div>
                    <div class="col-md-4">
    ...
    <footer class="pt-4 my-md-5 pt-md-5 border-top">
        <div class="row">
            <div class="col-12 col-md">
                <img class="mb-2" src="https://cdn-icons-png.flaticon.com/128/669/669698.png" alt="" width="65"
                    height="55">
